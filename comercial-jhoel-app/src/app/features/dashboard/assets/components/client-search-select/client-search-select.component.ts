 ...
 * server-side search endpoint. Duplicated per feature folder (same copy
 * lives under accounts-receivable/) rather than shared cross-feature,
 * matching this app's established convention for small per-feature UI.
 */
@Component({
